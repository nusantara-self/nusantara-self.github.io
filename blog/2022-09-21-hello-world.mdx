...
My name is **Fabien**, I'm a **28+ years old cybersecurity engineer** and.. this is my first blog post on here. :)

Most of my posts here will be **tech-related** and the main goal is to document my **learning** and **exploration journey**.

From time-to-time, some posts might be more *personal*, like *travel* or *music* related; I just hope to **make of that space one that truly defines things I wish to share** and I'm **passionnate about**. Making it as comfortable as I wish it to be.
