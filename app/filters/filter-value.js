(function () {
  ...
  angular
    ...
    .filter("filterValue", function (UtilsSrv, UiSettingsSrv) {
      return function (value) {
        ...
        if (angular.isArray(value)) {
          ...
          if (start !== null) {
            result.push(
              "From: " +
                moment(start).hour(0).minutes(0).seconds(0).format(dateFormat)
            );
          }
          ...
          if (end !== null) {
            result.push(
              "To: " +
                moment(end).hour(23).minutes(59).seconds(59).format(dateFormat)
            );
          }
